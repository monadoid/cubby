...
/// Trait for types that can be generated by Apple Foundation Models.
///
/// Implement this trait for any Rust type that corresponds to a Swift `@Generable`
/// struct exposed by the bridge.
