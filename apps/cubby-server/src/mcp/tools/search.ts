...
mcpServer.tool("search", {
  description:
    "Search screen and audio content on a user's Screenpipe device. Supports filtering by text query, content type (ocr/audio/ui), time range, application, and more.",
