...
/**
 * Types of content that can be queried in cubby.
 */
...
/**
 * Parameters for querying cubby.
 */
export interface cubbyQueryParams {
...
/**
 * Structure of the response from a cubby query.
 */
