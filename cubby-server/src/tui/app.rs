...
impl TabsState {
    pub const fn new(titles: Vec<&'static str>) -> Self {
        Self { titles, index: 0 }
    }
...
pub struct App {
    ...
    pub logs: StatefulList<LogEntry>,
    pub signals: Signals,
...
impl App {
    pub fn new(title: &str, enhanced_graphics: bool) -> Self {
        ...
        App {
            ...
            tasks: StatefulList::with_items(TASKS.iter().map(|s| s.to_string()).collect()),
            ...
            servers: vec![
                Server {
                    name: "NorthAmerica-1".to_string(),
                    location: "New York City".to_string(),
                    coords: (40.71, -74.00),
                    status: "Up".to_string(),
                },
                Server {
                    name: "Europe-1".to_string(),
                    location: "Paris".to_string(),
                    coords: (48.85, 2.35),
                    status: "Failure".to_string(),
                },
                Server {
                    name: "SouthAmerica-1".to_string(),
