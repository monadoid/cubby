...
import { buildAuthorizationUrl, calculatePKCECodeChallenge, createOAuthContext, exchangeAuthorizationCode, generateRandomCodeVerifier, generateRandomState, validateCallbackParameters, } from './lib/oauth';
...
app.get('/callback', async (c) => {
    ...
    try {
        const connection = await exchangeAuthorizationCode(context, callbackParameters, oauthConfig.redirectUri, session.codeVerifier);
        clearSessionCookie(c, secureCookies);
