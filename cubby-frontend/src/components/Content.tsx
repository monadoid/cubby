      ...
      <div style="background-color: #000; padding: 2rem; pointer-events: auto;">
        <div class="w-full max-w-4xl mx-auto px-4">
          ...
          <div class="flex items-stretch gap-0 mx-auto mb-8" style="max-width: 400px; margin-top: 1.5rem;">
            ...
            <button 
              onclick="navigator.clipboard.writeText(' curl -s https://get.cubby.sh/cli | sh'); this.style.backgroundColor='#fff'; this.style.color='#000'; setTimeout(() => { this.style.backgroundColor='#222'; this.style.color='#fff'; }, 75);"
