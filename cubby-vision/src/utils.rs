...
impl From<OcrEngine> for DbOcrEngine {
    fn from(val: OcrEngine) -> Self {
        match val {
            OcrEngine::Unstructured => DbOcrEngine::Unstructured,
...
impl From<DbOcrEngine> for OcrEngine {
    fn from(engine: DbOcrEngine) -> Self {
        match engine {
            DbOcrEngine::Unstructured => OcrEngine::Unstructured,
            DbOcrEngine::Tesseract => OcrEngine::Tesseract,
            DbOcrEngine::WindowsNative => OcrEngine::WindowsNative,
            DbOcrEngine::AppleNative => OcrEngine::AppleNative,
            DbOcrEngine::Custom(config) => OcrEngine::Custom(config.into()),
        }
    }
}
