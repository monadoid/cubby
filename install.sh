...
echo "downloading cubby v${VERSION} for ${arch}-${os}..."
...
echo "installing..."
INSTALL_DIR="$HOME/.local/cubby"

# Remove existing installation
rm -rf "$INSTALL_DIR"

# Create install directory
if ! mkdir -p "$INSTALL_DIR/cubby-vision/lib"; then
...
# Copy binary
if ! cp bin/cubby "$INSTALL_DIR/"; then
...
mkdir -p "$HOME/.local/bin"
if ! ln -sf "$INSTALL_DIR/cubby" "$HOME/.local/bin/cubby"; then
