...
<Expandable title="How can I monetize my custom pipes (plugins)?">
  - you can publish your pipes to the cubby store and earn money
  - set your own pricing model (subscription or one-time purchase)
  - publish using the CLI: `bunx --bun @cubby/dev@latest pipe publish --name your-pipe \[--paid --price 50\]`
...
<Expandable title="How do I develop and test a pipe locally?">
  - create a new pipe with: `bunx --bun @cubby/dev@latest pipe create`
  - navigate to your pipe directory: `cd your-pipe-name`
  - start development server: `bun run dev`
  - test your pipe locally in the cubby app
...
<Expandable title="What are the hardware requirements for running cubby?">
  ...
  - cubby is optimized to use hardware acceleration when available, significantly reducing CPU usage
</Expandable>

<Expandable title="How can I contribute to the cubby project?">
  - cubby is open source and welcomes contributions
  - check our [GitHub Issues](https://github.com/monadoid/cubby/issues) for tasks to work on
  - join our [Discord community](https://discord.gg/dU9EBuw7Uq) to collaborate with other contributors
  - follow our [contribution guidelines](https://github.com/monadoid/cubby/blob/main/CONTRIBUTING.md) for code standards
  - submit pull requests with features, bug fixes, or documentation improvements
</Expandable>

<Expandable title="What's the cubby operator feature?">
...
<Expandable title="What file formats does cubby use for recording?">
  - screen recordings are stored as mp4 files
  - audio recordings are stored as mp3 files
  - all files are saved in $HOME/.cubby/ directory
...
<Expandable title="How can I backup or transfer my cubby data?">
  - all data is stored in $HOME/.cubby/ directory
