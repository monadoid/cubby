...
use cubby_db::{AudioDevice as DbAudioDevice, DeviceType as DbDeviceType};
...
impl From<DbDeviceType> for DeviceType {
    fn from(device_type: DbDeviceType) -> Self {
        match device_type {
            DbDeviceType::Input => DeviceType::Input,
            DbDeviceType::Output => DeviceType::Output,
        }
    }
}
...
impl From<DeviceType> for DbDeviceType {
    fn from(device_type: DeviceType) -> Self {
        match device_type {
            DeviceType::Input => DbDeviceType::Input,
            DeviceType::Output => DbDeviceType::Output,
        }
    }
}

impl From<DeviceType> for Arc<DbDeviceType> {
    fn from(device_type: DeviceType) -> Self {
...
impl From<DbAudioDevice> for AudioDevice {
    fn from(device: DbAudioDevice) -> Self {
        AudioDevice {
            name: device.name,
